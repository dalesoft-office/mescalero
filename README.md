...
2. You can easily replace parts of Mescalero with another graphical libraries without changing your codebase
...
mscl_lld.pro - QT 5 project (LittleCMS as ICC, LibRAW as RAW). lcms2.dll and libraw.dll are required
